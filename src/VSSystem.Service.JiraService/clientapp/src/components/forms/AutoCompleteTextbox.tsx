...
function AutoCompleteTextbox(props?: componentProps & {
    ...
    try {
        ...
        let contents = (<div ref={thisRef} id={thisId} className={className} onClick={evt => onClick(evt)}>
            <div>
                <input tabIndex={props.tabIndex} id={inputId} onChange={onChange} type={props.type} placeholder={props.placeholder} required={props.required} defaultValue={props.defaultValue} defaultChecked={props.defaultChecked} />
            </div>
