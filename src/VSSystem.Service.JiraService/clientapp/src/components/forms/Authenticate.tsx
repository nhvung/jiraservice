...
function Authenticate(props?: componentProps & {
    ...
    apiUrlOptionsHandler?: () => string[] | undefined,
    ...
    try {
        ...
        if (props.apiUrlOptions || props.apiUrlOptionsHandler) {
            apiUrlDiv = (<AutoCompleteTextbox
                id={`${thisId}-api-url`}
                type={"text"}
                placeholder={props.apiUrlLabel ?? "Api url"}
        ...
        if (authType == AuthenticationType.UsernameAndPassword) {
            ...
            let usernameDiv = (<AutoCompleteTextbox
                id={`${thisId}-username`}
                type={"text"}
                placeholder={props.usernameLabel ?? "Username"}
                tabIndex={++tabIndex}
            ...
            let passwordDiv = (<AutoCompleteTextbox
                id={`${thisId}-password`}
                type={"password"}
                placeholder={props.passwordLabel ?? "Password"}
                tabIndex={++tabIndex}
