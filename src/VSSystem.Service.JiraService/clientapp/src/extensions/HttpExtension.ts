...
function httpActionAsync(url: string, method?: httpMethodMap | string, data?: any, headers?: HeadersInit | any, onSuccess?: (response: Response) => Promise<any>, onError?: (error: any) => Promise<any>, onFinally?: () => void) {
    try {
